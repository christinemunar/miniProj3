//
//  LocationCocoapodViewController.swift
//  miniProj3
//
        ...
        if CLLocationManager.locationServicesEnabled() {
            if CLLocationManager.authorizationStatus() == .Denied{
                ...
                if CLLocationManager.authorizationStatus() == .NotDetermined{
                    ...
                    self.showLocationRequestController(setTitle: "Tell Us Where You Are!", setAllowButtonTitle: "Alright", setNotNowButtonTitle: "Not now", setMapViewAlphaValue: 0.7, setBackgroundViewColor: UIColor.lightGrayColor())
                }else{
